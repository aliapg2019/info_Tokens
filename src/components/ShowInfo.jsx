...
const ShowInfo = ({handleBtn, infoContract, setInfoContract}) => {
    return ( 
        <>
            <div>
                <div class=" w-full rounded-xl sm:w-auto shadow-lg mx-auto p-4 border border-gray-200 shadow-md sm:p-6 lg:p-8 bg-gray-800 border-gray-700">
                    <form class="space-y-6" onSubmit={handleBtn}>
                                        ...
                                        <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700 rounded-lg">
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                                <tr class="hover:bg-gray-100 hover:bg-gray-700 hover:rounded-lg rounded-lg">
                                                    <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">{infoContract.nameToken}</td>
                                                    <td class="py-4 px-6 text-sm font-medium text-gray-500 whitespace-nowrap dark:text-white">{infoContract.symbol}</td>
                                                    <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">{String(infoContract.totalSupply)}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
